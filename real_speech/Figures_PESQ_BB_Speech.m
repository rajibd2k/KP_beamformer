%%% PESQ (wideband) for kronecker fixed /+ adaptive beamforming
%%% Varying iSIR
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for idx_intf_type = 1:length(intf_type)  
    ...
    xlabel('iSIR (dB)') ; ylabel('PESQ-BB (dB)') ; title(intf_type{idx_intf_type}) ; axis('tight') ;
